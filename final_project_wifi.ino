...
#define BLYNK_TEMPLATE_ID "TMPLZ1Yg4qpu"
#define BLYNK_DEVICE_NAME "finalproject"
#define BLYNK_AUTH_TOKEN "Uw96iJkPFd0kl1Iu_b39ISQ0RFjL8njG"
...
BLYNK_WRITE(V0) {
  int up = param.asInt();
  digitalWrite(16, up); // D0
  digitalWrite(5, 0); // D1
  digitalWrite(4, 0); // D2
}
BLYNK_WRITE(V1) {
  int up = param.asInt();
  digitalWrite(5, up); // D1
  digitalWrite(16, 0); // D0
  digitalWrite(4, 0); // D2
}
BLYNK_WRITE(V2) {
  int up = param.asInt();
  digitalWrite(4, up); // D2
  digitalWrite(5, 0); // D1
  digitalWrite(16, 0); // D0
}
